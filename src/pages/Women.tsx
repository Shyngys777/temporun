...
const womenProducts = [
  ...
  {
    id: 'endorphin-speed-women',
    name: 'Endorphin Speed 3',
    brand: 'Saucony',
    price: 160,
    colorway: 'Coral/White',
      ...
      <div className="flex flex-col min-h-screen">
        ...
        <main className="flex-grow pt-24">
          ...
          <div className="relative h-96 overflow-hidden">
            <img
                src="https://images.unsplash.com/photo-1649972904349-6e44c42644a7?ixlib=rb-4.0.3&auto=format&fit=crop&w=2000&h=600&q=80"
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-black/70 to-transparent flex items-center">
              <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
                <div className="max-w-xl">
                  <h1 className="text-4xl md:text-5xl font-display font-bold text-white mb-4">Women's Running Shoes</h1>
                  <p className="text-lg text-white/80 mb-8">
                    Engineered for performance and designed for style. Find your perfect pair today.
                  </p>
